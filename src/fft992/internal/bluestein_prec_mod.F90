...
#ifndef FFTB_PLAN
#error "FFTB_PLAN must be defined before including bluestein_prec_mod.F90"
#endif

#ifndef FFTB_TYPE
#error "FFTB_TYPE must be defined before including bluestein_prec_mod.F90"
#endif

#ifndef BLUESTEIN_INIT
#error "BLUESTEIN_INIT must be defined before including bluestein_prec_mod.F90"
#endif

#ifndef BLUESTEIN_FFT
#error "BLUESTEIN_FFT must be defined before including bluestein_prec_mod.F90"
#endif

#ifndef BLUESTEIN_TERM
#error "BLUESTEIN_TERM must be defined before including bluestein_prec_mod.F90"
#endif
...
CALL FFT992(ZY,TB%TRIGS(1:M,IPO2),TB%NFAX(1:10,IPO2),IINC,IJUMP,M,ILOT,IFFTSIGN)
...
DO WHILE( M<=2*TB%NDLON-2)
  M=M*2
  IPO2=IPO2+1
  CALL SET99B(TB%TRIGS(1:M,IPO2),TB%NFAX(1:10,IPO2),M,LLUSEFFT992)
...
DO JLAT=1,TB%NLAT_COUNT
  ...
  DO ISIGN=1,2
    ...
    CALL FFT992(TB%FFTB(N)%H2xT(:,:,ISIGN),TB%TRIGS(1:M,IPO2),TB%NFAX(1:10,IPO2),IINC,IJUMP,M,ILOT,IFFTSIGN)
